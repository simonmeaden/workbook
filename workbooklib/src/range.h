...
public:
    explicit Range();
    explicit Range(const int &row1, const int &column1, const int &row2, const int &column2);
    explicit Range(const CellReference topLeft, const CellReference bottomRight);
